...
- hltbPlaytimeMain: number or null (average hours to beat the main story, as a decimal like 6.5)
- hltbPlaytimeComplete: number or null (average hours for 100% completion)
